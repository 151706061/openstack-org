...
<div class="container">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4">
        ...
        <div class="add-your-course">
            <p>
                Does your company offer remotely managed private clouds for OpenStack? Be listed here!<a href="mailto:ecosystem@openstack.org">Email us for details</a> or <a href="https://www.linuxfoundation.org/meetings/jmcarthur3">book a time</a> to meet remotely.
            </p>
        </div>
    </div>
</div>
